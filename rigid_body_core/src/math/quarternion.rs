...
impl Quarternion {
	...
	if trace >= 0. {
		...
		0 => {
		    let mut s =
			(matrix[0][0]-(matrix[1][1]+matrix[2][2])+1.).sqrt();
		    ret.v[0] = 0.5*s;
		    s = 0.5/s;
		...
		1 => {
		    let mut s =
			(matrix[1][1]-(matrix[2][2]+matrix[0][0])+1.).sqrt();
		    ret.v[1] = 0.5*s;
		    s = 0.5/s;
		...
		2 => {
		    let mut s =
			(matrix[2][2]-(matrix[0][0]+matrix[1][1])+1.).sqrt();
		    ret.v[2] = 0.5*s;
		    s = 0.5/s;
